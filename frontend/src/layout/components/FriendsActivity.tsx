...
const FriendsActivity = () => {
    const { users,isLoading,error,onlineUsers,fetchUsers,userActivities}=useChatStore();
    const {user}=useUser();
            ...
            <div className="p-4 space-y-4">
                {
                    users.map((user)=>{
                        ...
                        <div key={user._id} className='cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group'> 
                            <div className='flex items-start gap-3 w-[20vw]'>
                                <div className="relative flex w-[20vw] gap-10 items-center">
...
const FriendsActivity = () => {
    ...
    console.log("User Activities in UI:", userActivities);
	return (
		<div className='h-full bg-zinc-900 rounded-lg flex flex-col'>
			<div className='p-4 flex justify-between items-center border-b border-zinc-800'>
				<div className='flex items-center gap-2'>
